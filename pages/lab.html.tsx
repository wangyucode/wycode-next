...
import LabItem2 from "../components/lab/lab-item-2";
    ...
    return (
        <Layout>
            <div
                ...
                <LabItem title="3D滚蛋吧" img={rollImg} detail="微信扫一扫，一起来玩滚蛋吧，看谁滚的远...😂"/>
                <LabItem title="跨平台剪切板" img={clipboardImg} link="/clipboard.html"
                         detail="跨平台跨网络发送文字，保存信息？最简单的方式：使用 跨平台剪切板 即可："/>
                <LabItem title="DOTA2英雄技能物品天梯助手" img={dotaImg} detail="玩DOTA2，查英雄，查物品，查赛事，查天梯排行就看DOTA2英雄技能物品天梯助手"/>
                <LabItem2 title="谁是卧底发牌员" img1={dealer1Img} img2={dealer2Img}
                          deprecated="暂停维护"
                          link="https://wycode.cn/dealer/"
                          github="https://github.com/wangyucode/dealer" detail="线下聚会必备，只需要一个网页链接就能一起玩..."/>
                <LabItem2 title="Websocket聊天室" img1={chat1Img} img2={chat2Img}
                          deprecated="暂停维护"
                ...
                <LabItem2 title="西安公共自行车" img1={bike1Img} img2={bike2Img} link="https://wycode.cn/lib/bike.apk"
                          github="https://github.com/wangyucode/XiAnBike"
                          detail="开源、纯净、无广告；省电、安全、不推送；适配安卓2.3至安卓7.1的纯净版西安自行车网点查询来了，还你一个简单纯净的出行APP，立即下载："/>
                <LabItem title="养鱼小助手" img={fishImg} deprecated="已下架 2020年3月" detail="造福鱼友：查养鱼攻略，查鱼类品种，问答社区"/>
                <LabItem2 title="局域网五子棋" img1={chessImg}
                         github="https://github.com/wangyucode/FiveChess"
                         detail="JavaFX技术实现的五子棋，可以局域网对局，可以聊天，可以自动判定胜负，可以悔棋，总代码不超过1000行，编译后仅18KB"/>
                <LabItem title="宝宝圈亲友云相册" img={albumImg}
