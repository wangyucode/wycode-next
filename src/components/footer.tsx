...
export default function Footer() {
    return (
        <footer className='h-10 shadow-sm bg-base-200/60 backdrop-blur fixed z-10 bottom-0 right-0 left-0 flex flex-col md:flex-row justify-center items-center py-2 border-t border-slate-400/30 text-xs md:text-sm'>
